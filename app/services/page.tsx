      ...
      <section id="services-overview" className="py-20 bg-white">
        <div className="container-page">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white p-8 rounded-lg shadow-xl border-t-4 border-peach-500 hover:shadow-2xl transition-all duration-300 group">
              <div className="w-16 h-16 bg-peach-100 text-peach-700 flex items-center justify-center rounded-full mb-6 mx-auto group-hover:bg-peach-600 group-hover:text-white transition-all duration-300">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-xl">
              ...
              <div className="absolute inset-4 z-10 shadow-xl rounded-lg overflow-hidden bg-peach-300 flex items-center justify-center">
                <TbBuildingSkyscraper className="w-24 h-24 text-white" />
              </div>
            </div>
          </div>
        ...
        <div className="container-page">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-xl order-2 md:order-1">
              ...
              <div className="absolute inset-4 z-10 shadow-xl rounded-lg overflow-hidden bg-peach-300 flex items-center justify-center">
                <HiOutlineChatAlt2 className="w-24 h-24 text-white" />
              </div>
            </div>
        ...
        <div className="container-page">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-xl">
              ...
              <div className="absolute bottom-0 left-0 w-48 h-48 bg-peach-100 rounded-lg transform -translate-x-6 translate-y-6"></div>
              <div className="absolute inset-4 z-10 shadow-xl rounded-lg overflow-hidden bg-peach-300 flex items-center justify-center">
                <MdBusinessCenter className="w-24 h-24 text-white" />
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full bg-peach-200 flex items-center justify-center mr-4">
                    <span className="text-peach-600 font-bold">MK</span>
                  </div>
                  <div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full bg-peach-200 flex items-center justify-center mr-4">
                    <span className="text-peach-600 font-bold">AA</span>
                  </div>
                  <div>
